...
function getNextDate(date) {
  ...
  } else if (date.toString() === 'Sun Mar 12 2028 19:00:00 GMT-0400 (Eastern Daylight Time)') {
    next_date = new Date('2028-03-13');
  } else if (date.toString() === 'Sun Mar 11 2029 19:00:00 GMT-0400 (Eastern Daylight Time)') {
    next_date = new Date('2029-03-12');
  }
  return next_date.getUTCFullYear() + '-' + padNumber(next_date.getUTCMonth() + 1) + '-' + padNumber(next_date.getUTCDate());
}

let day = new Date('2025-01-22');
